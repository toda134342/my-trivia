...
const SONG_ROUNDS = [
  ...
  { clue: '🎵 שיר לשלום... לא תחזיר...', answer: 'שיר לשלום', opts: ['שיר לשלום', 'הלוויתן', 'לא תיסוף', 'שאו ציון'], correct: 0, xxxxxxxx: 'xxxxxx' },	  	  { xxxx: 'x xxxxxxx xx xxx... xxx xxx...', xxxxxx: 'xxxxxxx xx xxx', xxxx: ['ירושלים שלי', 'ירושלים של זהב', 'עיר הקודש', 'שיר ירושלים'], correct: 1, category: 'ישראלי' },
  { clue: '🎵 בשנה הבאה נשב על המרפסת...', answer: 'בשנה הבאה', opts: ['השנה הזו', 'בשנה הבאה', 'שנה טובה', 'תפילה'], correct: 1, xxxxxxxx: 'xxxxxx' },	  	  { xxxx: 'x xxx xx xxx... xxx xx xxx xx xxxxxx...', answer: 'שיר ים תיכוני', opts: ['ים תיכון', 'שיר ים תיכוני', 'שיר לים', 'הים הגדול'], correct: 1, category: 'ישראלי' },
