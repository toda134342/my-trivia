...
const NARRATOR_ROAST = [
  ...
  '{name}, זה היה ניחוש אמיץ. אמיץ ולא נכון',
  'טעות קטנה {name}... רק כל התשובה',
  '{name}, בפעם הבאה תסגור עיניים ותצביע, אולי יעבוד יותר טוב',
  'וואו {name}, זה היה רחוק. ממש רחוק',
  '{name}, אני חושב שהתבלבלת עם שאלה אחרת לגמרי',
  'לא נורא {name}, גם לגאונים יש רגעים חלשים',
  '{name} הפתיע את כולם... לא בדרך הטובה',
  'מי אמר ל{name} שזו התשובה? תפטרו אותו',
  '{name}, זה בדיוק ההפך מהתשובה הנכונה',
  'בגלגול הבא {name}, הפעם זה לא הסתדר',
  '{name}, הקהל בטח מחייך עכשיו',
  'טוב ניסיון {name}, ממש טוב ניסיון... שנכשל',
  '{name}, בואו נגיד שזה לא היה הרגע שלך',
  'אני מקווה שזה לא היה בגלל חוסר שינה {name}',
  '{name}, זה בטח נראה טוב בראש שלך',
  'מישהו יעביר ל{name} ספר יסוד בבקשה',
  '{name}, גם אני הייתי טועה ככה... אולי',
  'לא היום {name}, לא היום',
  '{name}, הפעם התשובה ברחה ממך',
  'אוף {name}, כל כך קרוב ובכל זאת רחוק',
  '{name}, בטוח שלחצת על הכפתור הנכון?',
  '{name}, זה ניחוש שאפילו קוסם לא היה מנחש',
  'אה {name}, זה כאב לשמוע',
  '{name}, מישהו כאן צריך תה חם ורגע לחשוב',
  'וואי {name}, זה היה ממש לא קרוב',
  '{name}, הקהל שותק בהלם',
  'כמעט {name}... כמעט בכיוון ההפוך',
  '{name}, זה בטח נשמע יותר טוב בראש',
  'מישהו תפוס פה {name}, אני מרגיש',
  '{name}, הפעם זה לא היה היום שלך',
  'וואו {name}, זה היה אמיץ מאוד. אמיץ ולא נכון',
  '{name}, זה בדיוק מה שלא הייתי עונה',
  'אני חושב ש{name} התבלבל עם משחק אחר לגמרי',
  '{name}, נשמע שהיה לך יום עמוס',
  'לא נורא {name}, יש עוד שאלות',
  '{name}, זה ניחוש שגורם לי לדאוג קצת',
  'וואי וואי {name}, זה כואב',
  '{name}, בטח פספסת את השורה',
  'מישהו יגיש ל{name} כוס מים ורגע להתאושש',
  '{name}, זה היה רחוק כמו הירח',
  'אוקיי {name}, ננסה שוב בפעם הבאה',
  '{name}, זה בדיוק מה שלא רצינו לשמוע',
  'וואו {name}, איזה כיוון מעניין שבחרת. הלא נכון',
  '{name}, אני מקווה שזה היה בכוונה',
  'מישהו שכח לקרוא את השאלה {name}?',
  '{name}, זה לא בדיוק מה שביקשנו',
  'אוף, {name}, קרוב לגמרי לתשובה הלא נכונה',
  '{name}, בואו נעצום עין הפעם. רק הפעם',
  'וואי {name}, זה ריגש אותי בדרך הלא נכונה',
];
const NARRATOR_COMPLIMENT = [
  ...
  '{name}, זה היה מהיר ומדויק, כבוד',
  'מישהו קרא ספרים {name}, וזה ניכר',
  '{name}, אני מרים כובע',
  'בול פגיעה {name}, בול',
  '{name}, המוח שלך עובד מעולה היום',
  'וואו {name}, לא ציפיתי לפחות מזה',
  '{name}, זה היה ברמה של אלוף עולם',
  'תנו כפיים ל{name}, זה היה מרשים',
  '{name}, אתה פשוט בקטע אחר',
  'מדויק {name}, כמו תמיד',
  '{name}, הידע שלך מרשים באמת',
  'וואלה {name}, מכבד את זה',
  '{name}, זה בדיוק מה שציפיתי מאלוף',
  'כל הכבוד {name}, זה לא היה קל',
  '{name}, אתה בונה לך פה מוניטין',
  'יפה מאוד {name}, יפה מאוד',
  '{name}, זו הייתה תשובה של מומחה',
  'וואו {name}, איך ידעת את זה',
  '{name}, פשוט לא מפספס',
  'כל הכבוד {name}, ממשיך ככה',
  '{name}, זה היה טופ',
  'מכובד {name}, ממש מכובד',
  '{name}, זה בדיוק מה שציפינו מאלוף',
  'וואו {name}, זה היה חד כמו סכין',
  '{name}, המוח שלך על מנוע טורבו היום',
  'כל הכבוד {name}, זה לא מובן מאליו',
  '{name}, זו הייתה תשובה שאין עליה עוררין',
  'וואלה {name}, זה היה מדויק לגמרי',
  '{name}, אתה פשוט מכונת ידע',
  'תרימו כפיים ל{name}, ברצינות',
  '{name}, זה היה מבריק',
  'וואו {name}, זה בא בול זמן',
  '{name}, איזו החלטה מהירה ונכונה',
  'כל הכבוד {name}, שווה מדליה',
  '{name}, אתה כבר בליגה אחרת',
  'וואלה {name}, זה היה ברמת אלופים',
  '{name}, זה נראה קל בשבילך, מכבד',
  'תראו את {name}, שולט בחומר',
  '{name}, זו תשובה של מי שבאמת יודע',
  'וואו {name}, זה היה נקי ומדויק',
  '{name}, כל הכבוד, זה נהדר',
  'מרגש {name}, פשוט מרגש',
  '{name}, אתה עושה את זה נראה קל',
  'כל הכבוד {name}, זה היה מרשים ברמות',
  '{name}, המידע שלך פשוט חד',
  'וואלה {name}, כובע תרים לי בשבילך',
  '{name}, זו הייתה תשובה זהב',
  'תנו יד ל{name}, זה היה מעולה',
  '{name}, אתה פשוט לא מפסיק להפתיע',
...
const REVEAL_NARRATOR_FALLBACK_MS = 16000; // ✅ הוגדל מ-7000: טקסט reveal רגיל תמיד מוכן מראש (pre-warm)
// ומתנגן כמעט מיידית, אבל טקסט עם עקיצה/מחמאה (narratorZinger) לא ניתן ל-pre-warm כי לא
// יודעים מראש מי יטעה/יצליח — זה cache miss חד-פעמי שיכול לקחת 7+ שניות לייצור, ו-7000ms
...
const EDGE_VOICES = {
  ...
  'edge:avri-deep':      { label: '🎤 ד"ר — קריין עמוק ונמוך',   voice: 'he-IL-AvriNeural', rate: '-12%', pitch: '-14Hz' },
  'edge:avri-fast':      { label: '⚡ ספרינטר — קריין מהיר',     voice: 'he-IL-AvriNeural', rate: '+30%', pitch: '+0Hz'  },
  'edge:avri-warm':      { label: '🎙️ חבר — קריין חם ונעים',    voice: 'he-IL-AvriNeural', rate: '-10%', pitch: '-5Hz'  },
  'edge:hila':           { label: '👩 הילה — קריינית רגילה',    voice: 'he-IL-HilaNeural', rate: '+0%',  pitch: '+0Hz'  },
  'edge:hila-warm':      { label: '🎙️ הילה — קריינית חמה',     voice: 'he-IL-HilaNeural', rate: '-10%', pitch: '-5Hz'  },
  'edge:hila-energetic': { label: '⚡ הילה — קריינית אנרגטית', voice: 'he-IL-HilaNeural', rate: '+25%', pitch: '+15Hz' },
  'edge:avri-commander': { label: '🎖️ מפקד — סמכותי וחד',      voice: 'he-IL-AvriNeural', rate: '+8%',  pitch: '-12Hz', volume: '+35%' },
};
